                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p15b" align="center">
                                                    <h1 style="color: #333333; font-size: 20px;"><strong>Solicitud de Permisos</strong><strong></strong></h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="esd-block-text es-p40r es-p40l" align="center">
                                                    <p>Un administrador te a concedido permiso de realizar una accion de admin, pero sera con este codigo.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                  <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border"><p class="es-button" target="_blank">{{$code}}</p></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
